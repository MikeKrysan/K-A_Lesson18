package com.example.ka_lesson18_my1
...
import com.example.ka_lesson18_my1.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == Constance.REQUEST_CODE_SIGN_IN) {
            ...
            if(login == l && password == p) {
                ...
                bindingClass.imAvatar.visibility = View.VISIBLE
                bindingClass.tvInfo.text = "Такого пользователся не существует!"
                bindingClass.imAvatar.setImageResource(R.drawable.dulia)
            }
    ...
    fun onClickSignIn(view:View) {
        if(bindingClass.imAvatar.isVisible && bindingClass.tvInfo.text.toString() != "Такого пользователся не существует!") {
